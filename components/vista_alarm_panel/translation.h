...
extern inline char shift_extended_char(
    char extended_char)  // using known values provided in https://github.com/Tim
                         // Pletcher/esphome-vistaECP-idf/issues/3#issuecomment-2780955362
{
