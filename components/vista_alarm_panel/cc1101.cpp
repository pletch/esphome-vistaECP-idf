...
bool CC1101::begin() {
  ...
  ESP_LOGD(TAG,
           "MDMCFG4=0x%02X (want 0x87)  MDMCFG3=0x%02X (want 0x83)  MDMCFG2=0x%02X (want 0x30)  BSCFG=0x%02X (want "
           "0x00)  AGCCTRL0=0x%02X (want 0x91)  AGCCTRL2=0x%02X (want 0x07)  FSCTRL0=0x%02X (want 0x00)",
