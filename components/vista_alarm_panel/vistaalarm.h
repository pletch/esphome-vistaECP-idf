...
class vistaECPHome : public api::CustomAPIDevice, public time::RealTimeClock
{
    ...
    public:
      vistaECPHome(char kpaddr = KP_ADDR, int receivePin = RX_PIN, int transmitPin = TX_PIN, int uartnum1 = DEF_UART1, int monitorTxPin = MONITOR_PIN, int uartnum2 = DEF_UART2, int maxzones = MAX_ZONES, int maxpartitions = MAX_PARTITIONS);
