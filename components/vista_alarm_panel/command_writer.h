...
class CommandWriter {
 public:
  ...
  // modifies it.
  CommandWriter(VistaBus &bus, const PartitionManager &partitions) : bus_(bus), partitions_(partitions) {}
  ...
  bool keypress(const std::string &keys, int partition_id, const std::string &code = "");
